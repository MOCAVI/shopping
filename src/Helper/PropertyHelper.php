...
namespace ElasticExportShopping24\Helper;
...
class PropertyHelper
{
    ...
    // const SHOPPING24_DIREKTKAUF = 39.01;
...
*/
     ...
     * @return string|bool
     */
/*ADK    public function getProperty($variation, string $property)
    {
        ...
        if(!array_key_exists($variation['data']['item']['id'], $this->itemPropertyCache))
        {
            ...
            foreach($variation['data']['properties'] as $property)
            {
                    ...
                    $property['property']['valueType'] != 'file')
                {
                    ...
                    {
                        $this->getLogger(__METHOD__)->debug('ElasticExportShopping24::item.variationPropertyNotAdded', [
            ...
            $this->getLogger(__METHOD__)->debug('ElasticExportShopping24::item.variationPropertyList', [
                'ItemId'        => $variation['data']['item']['id'],
                'VariationId'   => $variation['id'],
